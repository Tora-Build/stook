...
pub struct Series {
    ...
    pub active: bool,
    pub bump: u8,
    /// Variance of daily log returns, WAD. Seeded at creation from the
    /// anchor's history; updated by every settlement after that.
    pub var_wad: i128,
...
impl Series {
    ...
    /// last one, scaled to a day, weighted in at 6%. An observation older
