...
describe("ladder sdk", () => {
  it("hard-codes the discriminators Anchor derives", () => {
    ...
    const built: [string, Uint8Array][] = [
      ...
      ["ladder_lp_join", L.joinLadderIx(refs, { lp: k, lpToken: k, index: 0, deposit: 1n, expectedSeq: 0n, maxGross: 1n }).data],
      ...
      ["ladder_create", L.createLadderIx({ creator: k, series: k, index: 3, quoteMint: k, creatorToken: k, tokenProgram: k, seed: 1n, maxGross: 1n }).data],
    ];
