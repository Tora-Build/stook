...
units=()
[[ $WHAT == stook || $WHAT == all ]] && units+=(stook-keeper.service stook-tape.service stook-keeper-watchdog.service stook-keeper-watchdog.timer stook-tape-watchdog.service stook-tape-watchdog.timer)
