...
export interface Anchor {
  ...
  hours: string;
  dp: number;
  /** Band width, as the program's tier (0 = 0.25% … 5 = 8%): chosen so an
   *  ordinary day moves about four bands, which is what the opening odds assume. */
  tier: number;
}
...
export const COINS: Coin[] = [
  {
    ...
    anchor: { symbol: "SPYx", name: "S&P 500", mint: "XsoCS1TfEyfFhfvj8EtZ528L3CaKBDBRqRapnBbDF2W", logo: "/logos/spyx.png", feedId: "2817b78438c769357182c04346fddaad1178c82f4048828fe0997c3c64624e14", hours: "24/7", dp: 2, tier: 0 },
  },
  {
    ...
    anchor: { symbol: "ZEC", name: "Zcash", mint: "A7bdiYdS5GjqGFtxf17ppRHtDKPkkRqbKtR27dxvQXaS", logo: "/logos/zec.svg", feedId: "be9b59d178f0d6a97ab4c343bff2aa69caa1eaae3e9048a65788c529b125bb24", hours: "24/7", dp: 2, tier: 2 },
  },
  {
    symbol: "KNOTS", name: "KNOTS", logo: "/logos/knots.png", mint: "8RVBk8vxLiUHueLUW1f4izFVqN3nWippLhkohKg6EGkS", decimals: 6, feeBps: 300,
    anchor: { symbol: "STONK", name: "STONK", mint: "6GmAFSYs4gk3FDao5FzzySQpPZaWsa4rUJHacpMpUNgx", logo: "/logos/stonk.png", feedId: "f68272be1240150c36b54dce26a9b75f62f507a94f49f43533a5050c77e07049", hours: "24/7", dp: 4, tier: 3 },
  },
  {
    symbol: "GP", name: "RuneScape Gold", logo: "/logos/gp.jpg", mint: "HTmQz7My6MehV7bjhJ6jde8nDND1yvsz68d24LP7YgUQ", decimals: 6, feeBps: 300,
    anchor: { symbol: "GLDx", name: "Gold", mint: "Xsv9hRk1z5ystj9MhnA7Lq4vjSsLwzL2nxrwmwtD3re", logo: "/logos/gldx.png", feedId: "e7d1138d0083368634087268c64b7bea0b4101a6365f83915cba9e76a8364b96", hours: "24/7", dp: 2, tier: 0 },
  },
];
 ...
 * feed is entitled.
 */
const DEVNET_FEEDS: Record<string, { symbol: string; name: string; feedId: string; dp: number; tier: number }> = {
  STOOK: { symbol: "BTC", name: "Bitcoin", feedId: "e62df6c8b4a85fe1a67db44dc12de5db330f7ac66b72dc658afedf0f4a415b43", dp: 0, tier: 1 },
  ZCAT: { symbol: "ETH", name: "Ether", feedId: "ff61491a931112ddf1bd8147cd1b641375f79f5825126d665480874634fd0ace", dp: 2, tier: 2 },
  KNOTS: { symbol: "SOL", name: "Solana", feedId: "ef0d8b6fda2ceba41da15d4095d1da392a0d2f8ed0c6c7bc0f4cfac8c280b56d", dp: 2, tier: 2 },
  GP: { symbol: "DOGE", name: "Dogecoin", feedId: "dcef50dd0a4cd2dcc17e45df1676dcb336a11a61c69df7a0299b0150c672d25c", dp: 4, tier: 2 },
};
...
export const anchorOf = (c: Coin): Anchor => {
  ...
  return d ? { ...c.anchor, symbol: d.symbol, name: d.name, feedId: d.feedId, dp: d.dp, tier: d.tier } : c.anchor;
};
