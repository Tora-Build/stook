        ...
        {cells.map((d, i) => {
          ...
          const body = (
            <>
              ...
              {early && <div className="wc-info wc-sub" title="A day can be funded up to two months ahead.">funding opens {new Date(Number(terms.fundableFrom) * 1000).toLocaleDateString("en-US", { weekday: "short" })}</div>}
